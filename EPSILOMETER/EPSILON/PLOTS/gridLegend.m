...
switch location,
    ...
    case {'eastoutside'}
        ...
        np=[(axPos(1)+axPos(3)) 2*axPos(1) width pos(4)*numpercolumn/numlines];
    ...
    case {'northeast'}
        % middle top location
        np=[(axPos(1)+axPos(3))-width  axPos(2)+axPos(4)-pos(4)*numpercolumn/numlines width pos(4)*numpercolumn/numlines]; 
        % define the new axis postion and apply
    case {'northwest'}
        % middle top location
        np=[axPos(1)  axPos(2)+axPos(4)-pos(4)*numpercolumn/numlines width pos(4)*numpercolumn/numlines]; 
        % define the new axis postion and apply
    otherwise
