...
data_folder=('/Volumes/MOD_dev/Projects/Epsilometer/CALIBRATION/SHEAR_PROBES/%s' % str(probeSerialNo))
try:
...
# write Calibration number Sv and Capacitance C in a text file

file = open(data_folder + "/Calibration_{}.txt".format( str(probeSerialNo) ), "a")
file.write( "date , Sv , C \n")
file.write( "%s, %2.2f, %3.1f\n" % (time.asctime(),svCalc,capacitanceS) )
file.close()
