%read config file
function setup=mod_som_read_setup(filepath)
...
%% parse modules
modules_headers=["CALENDAR","CAL","EFE","SBE","SBE49","SBE41","S49","S41","SDIO","VOLT","ALT","VOL"];
...
efe.header=efe.str(header_offset+(1:header_length)).';
...
sbe49.header=sbe49.str(header_offset+(1:header_length)).';
