...
EpsiConvert_timer.TimerFcn = [...
    ...
    'try, '...
    '[matData]=epsiProcess_convert_new_raw_to_mat(dirs,ec.Meta_Data,"fileStr",str_to_match);' ...
    'ec.Meta_Data=matData.Meta_Data; '...
    'catch err, '...
    ...
    'catch err, '...
    'display_error_stack(err); '...
    'disp("did not plot profile and section"); '...
    's=1;'...
    'end; '...
    'end;'];
