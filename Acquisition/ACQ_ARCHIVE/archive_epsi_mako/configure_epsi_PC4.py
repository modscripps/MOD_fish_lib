...
time.sleep(.1)
ser_write = serial.Serial('/dev/tty.usbserial-A9Z04EMH',230400)  # open serial port
...
str_cmd  = "settings.mission BLT3 EPSI4 \r\n"
bin_cmd=str_cmd.encode()
ser_write.write(bin_cmd)
time.sleep(.1)
print(bin_cmd)
