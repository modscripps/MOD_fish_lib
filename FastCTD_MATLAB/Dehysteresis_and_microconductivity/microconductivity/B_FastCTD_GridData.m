...
vars2Grid = {'pressure','temperature','conductivity','density','salinity','altdist','fluorometer','longitude','latitude','chi','eps','bottomdepth','lt','ppb1','ppb2'};
vars2Grid_default = {'pressure','temperature','conductivity','density','salinity','altdist','fluorometer','longitude','latitude','chi','eps','bottomdepth','lt','ppb1','ppb2'};
pickDownCast = true;
zInterval = 0.5;
zMin = 0;
zMax = 3000;
...
%         myFCTD.conductivity = FCTD.conductivity(ind);
        ...
        myFCTD.depth = sw_dpth(myFCTD.pressure,54);
...
if ~isfield(DataGrid.tGrid,'salinity')
...
if ~isfield(DataGrid.tGrid,'density')
