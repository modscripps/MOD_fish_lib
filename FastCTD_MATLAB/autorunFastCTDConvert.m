...
rawDirAway = '/Users/Shared/FCTD/RAW/';
matDir = '/Users/Shared/FCTD/MAT/';
matDirAway = '/Volumes/share/scienceshare/data/FCTD/MAT/';
dirs = {rawDir; rawDirAway; matDir};
...
FastCTDConvert_timer.TimerFcn = [...
    ...
    'try, '...
    ...%'FastCTD_MakeMatFromRaw_MISOBOB2019(dirs,''noGrid''); '...
    'FastCTD_MakeMatFromRaw(dirs,''noGrid''); '...
    'catch err, '...
    'disp(err); '...
    'end; '...
    'unix(sprintf(''/usr/bin/rsync -av %s %s'',matDir,RAW)); '...
