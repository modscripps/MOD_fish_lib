function DataGrid = FastCTD_GridDataF(FCTD,varargin)
%  DataGrid = FCTDMakeGrid(FCTD);
%
% DREWS HCAK for the NEW CHLA FISH (MISO-BOB CRUISE)
...
vars2Grid = {'pressure','temperature','conductivity','chla','bs','cdom'};
