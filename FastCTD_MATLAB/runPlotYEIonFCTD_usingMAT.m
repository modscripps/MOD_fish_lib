...
mypath = 	'/Users/Shared/FCTD/MAT/';
TimerStop = false;
myTimer = timer();
myTimer.StartFcn = 'figure(1000); clf; set(gcf,''Position'',get(0,''MonitorPositions''),''CloseRequestFcn'',''stop(myTimer);delete(myTimer); delete(gcf);'');';
