...
%ALB05222023_2 do not understand why 1500. We are barely going to 1640.
% Since I do not understand the if esle below I am switching this HARDCODED 1500
% to 1800m depth range
% if range(p) > 1500
if range(p) > 1800
    % ALB05222023_1, There is no dref anywhere. Setting it hard coded dref=1
    dref=1;
    p_ref_bin = 1000;
